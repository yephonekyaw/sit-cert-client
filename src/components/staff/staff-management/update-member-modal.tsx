...
const UpdateMemberModal = () => {
  const { updateModalState, setUpdateModalState } = useMemberStore();
  const { updateForm: form, onUpdateSubmit, isUpdating } = useMemberForm();

  return (
    <Dialog open={updateModalState} onOpenChange={setUpdateModalState}>
      <DialogContent
          ...
          <DialogDescription asChild>
            <div className="pt-2 space-y-3">
              <p className="text-slate-600 text-base">
                Update the information associated with this staff profile.
              </p>
